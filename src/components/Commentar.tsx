...
type CommentFormProps = {
    onSubmit: (payload: { newComment: string; userName: string; imageFile: File | null }) => void | Promise<void>;
    isSubmitting: boolean;
    error?: string;
};


// Komponen Comment (presentasional) — memo untuk menghindari render berlebih
const Comment = memo(({ comment, formatDate, index: _index, isPinned = false }: CommentProps) => (
    <div 
